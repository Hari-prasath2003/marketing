        ...
        <Container fluid>
            ...
            <Row className="part1">
                <Col md={6}>
                    ...
                    <h6 id="one">Create, manage, and analyze your display, Facebook, Instagram,<br></br>Pinterest, TikTok, and email campaigns from a single platform.<br></br> AdRoll helps marketers do more with less.
